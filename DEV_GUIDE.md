...
1. Code ändern.
2. `VERSION` in `sw.js` und `<meta name="app-version">` in `index.html` erhöhen — Semantic Versioning (`MAJOR.MINOR.PATCH`), z. B. `'v9.0.0'` → `'v9.1.0'` (neue Funktion) oder `'v9.0.1'` (Bugfix).
